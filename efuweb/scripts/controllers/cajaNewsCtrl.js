angular.module('mainapp').factory('CajaNewsService', CajaNewsService);

function CajaNewsCtrl($scope, $window, $cookies, $location, $stateParams, $state, CajaNewsService, Upload) {
    ...
    $scope.submit = function() {
        if ($scope.form.file.$valid && $scope.file) {
            ...
            // CajaNewsService.getArchivoProcesado($scope.file.name)
...
angular.module('mainapp').controller('cajaNewsCtrl', CajaNewsCtrl);