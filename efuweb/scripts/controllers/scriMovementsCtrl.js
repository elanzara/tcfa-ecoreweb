angular.module('mainapp').factory('ScriMovementsService', ScriMovementsService);

function ScriMovementsCtrl($scope, $window, $cookies, $location, $stateParams, $state, ScriMovementsService, $filter) {
    ...
    /*$scope.taxs = [];*/
    ScriMovementsService.getTax().then(function(response) {
        if (response.status == 200) {
...
angular.module('mainapp').controller('scriMovementsCtrl', ScriMovementsCtrl);