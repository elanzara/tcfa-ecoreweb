function CajaNewsService($http, $location, $cookies) {

    var cajaNewsResponse = {};

    var config = {
        headers: { 'Authorization': $cookies.getObject('token') }
    };

    cajaNewsResponse.getArchivoProcesado = function(file) {
        return $http.get(apiUrl + 'api/CajaNews/Procesado/' + file, config);
    };
    /*
