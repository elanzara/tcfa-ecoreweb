function SancorService($http, $location, $cookies) {
    ...
    sancorResponse.getArchivoProcesado = function(file) {
        return $http.get(apiUrl + 'api/Sancor/Procesado/' + file, config);
    };
    /*
